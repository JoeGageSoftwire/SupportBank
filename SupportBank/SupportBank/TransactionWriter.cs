...
namespace SupportBank
{
    class TransactionWriter
    {
        ...
        {
            Console.WriteLine($"{transaction.date.PadRight(24,' ')} {transaction.giverName.PadRight(14,' ')} {transaction.receiverName.PadRight(14,' ')} {transaction.narrative.PadRight(39,' ')} {transaction.amount}");
        }
        ...
        public void WriteAllTransactions(List<Transaction> transactionsFrom, List<Transaction> transactionsTo)
        {
            ...
            Console.WriteLine($"{"Date".PadRight(25,' ')}{"From".PadRight(15,' ')}{"To".PadRight(15,' ')}{"Narrative".PadRight(40,' ')}Amount");
